...
const GeneralLedger: React.FC = () => {
  ...
  const [entities, setEntities] = useState<FinancialEntity[]>([
    { id: '1', name: 'Balancete Livraria 2026', year: 2026, createdBy: 'Alzira Camargo', observations: 'Referente ao acervo literário e religioso da paróquia.', initialBalance: 2500.50 }
  ]);
